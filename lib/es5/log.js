...
var Log = function (_GSet) {
   ...
   * @return {Log}                            Log
   */
  function Log(ipfs, id, entries, heads, clock, acl, identity) {
    ...
    var clockId = _this._identity ? _this._identity.id : _this._id;
  ...
  (0, _createClass3.default)(Log, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return Entry.createAndPublish(this.id, data, nexts, this.clock, this._identity.id, this._identity, this._storage);
    ...
    key: 'validate',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(entries) {
        var _this3 = this;

        var permitted, verify;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                    ...
                    return _regenerator2.default.wrap(function _callee3$(_context3) {
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            _context3.next = 2;
                            return Entry.verify(_this3._identity, entry);
                ...
                _context4.next = 4;
                return pMap(entries, permitted, { concurrency: 1 });

              case 4:
                _context4.next = 6;
                return pMap(entries, verify, { concurrency: 1 });
    ...
    key: 'join',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(log) {
        var _this4 = this;

        var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
        var newItems, entriesToJoin, addToNextsIndex, tmp, notReferencedByNewItems, notInCurrentNexts, nextsFromNewItems, mergedHeads, maxClock;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                ...
                _context5.next = 8;
                return this.validate(entriesToJoin);
    ...
    key: 'fromMultihash',
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(ipfs, hash) {
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                return _context6.abrupt('return', Factories.createLogFromMultihash(ipfs, hash, length, exclude, acl, identity, onProgressCallback, Log));
    ...
    key: 'fromEntryHash',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(ipfs, hash, id) {
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                return _context7.abrupt('return', Factories.createLogFromEntryHash(ipfs, hash, id, length, exclude, acl, identity, onProgressCallback, Log));
      ...
      function fromEntryHash(_x12, _x13, _x14) {
    ...
    key: 'fromJSON',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(ipfs, json) {
        var length = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1;
        var acl = arguments[3];
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt('return', Factories.createLogFromJSON(ipfs, json, length, acl, identity, timeout, onProgressCallback, Log));
    ...
    key: 'fromEntry',
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(ipfs, sourceEntries) {
        var length = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1;
        var exclude = arguments[3];
        var acl = arguments[4];
        var identity = arguments[5];
        ...
        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                return _context9.abrupt('return', Factories.createLogFromEntry(ipfs, sourceEntries, length, exclude, acl, identity, onProgressCallback, Log));
